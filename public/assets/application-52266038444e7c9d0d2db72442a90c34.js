...
(function() {
  var initialize, populate, refresh;

  populate = function() {
    var animal, flickerAPI, flickerOptions, populateFields;
    ...
    populateFields = function(data) {
      ...
      return $('#photo_photo_tag').val(data.items[0].tags);
    };
    return $.getJSON(flickerAPI, flickerOptions, populateFields);
  };

  refresh = function() {
    var displayPhotos, refreshOptions, refreshURL;
    ...
    displayPhotos = function(data) {
      ...
      return $('#list_photos').html(tempHTML);
    };
    return $.getJSON(refreshURL, refreshOptions, displayPhotos);
  };

  initialize = function() {
    $('#photo_photo_link').on('change', populate);
    return $('#refresh_button').on('click', refresh);
  };
